  ...
  imapModule = types.submodule ({ config, ...}: {
    options = {
      ...
      password = mkOption {
        ...
        description = "IMAP password. Because these configuration files are kept in the nix store unencrypted, I recommend using some kind of a password command.";
      };
      ...
      url = mkOption {
        ...
        description = "IMAP address without the `imaps://`.";
      };
    };
  });
  smtpModule = types.submodule ({ config, ...}: {
    options = {
      ...
      password = mkOption {
        ...
        default = null;
        example = "`${pkgs.gnupg}/bin/gpg --decrypt passfile.gpg`";
        description = "SMTP password. Because these configuration files are kept in the nix store unencrypted, I recommend using some kind of a password command.";
      };
      ...
      url = mkOption {
        ...
        description = "SMTP address without the `smtps://`.";
      };
    };
  });
  ...
  options = {
    programs.neomutt = {
      ...
      spool = mkOption {
        ...
        default = "~/Mail/";
        example = "INBOX";
        description = "Mutt spool directory (maildir). When using IMAP, this will be appended to the end.";
      };
      ...
      folder = mkOption {
        ...
        description = "Default location for your mailboxes. If null it is derived from your spoolfile and imap.";
      };
      ...
      mailboxes = mkOption {
        ...
        description = "A list of mailboxes. If you prepend the path with `+` the path will be considered to be after the current folder.";
      };
      ...
      theme = mkOption {
        ...
        default = null;
        description = "Path to theme file. Warning this can contain any muttrc configuration, including system calls.";
      };
